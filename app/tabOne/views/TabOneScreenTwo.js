      ...
      <Swiper style={styles.wrapper} >
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>賢者的分享時間 Sage’s Sharing Time</Text>
                <Image 
          ...
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>海上求生技能坊-砲擊訓練 Basketball</Text>
                <Image 
                  style={styles.backdrop} 
          ...
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>海上求生技能坊-航海圖繪製Illustration</Text>
                <Image 
                  style={styles.backdrop} 
          ...
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>海上求生技能坊-船艇修繕Handicraft</Text>
                <Image 
                  style={styles.backdrop} 
          ...
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>海上求生技能坊-間諜訓練Drama</Text>
                <Image 
                  style={styles.backdrop} 
          ...
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>海上求生技能坊-專業導演Director</Text>
                <Image 
                  style={styles.backdrop} 
          ...
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>海上求生技能坊-海獸催眠師訓練Guitar</Text>
                <Image 
                  style={styles.backdrop} 
          ...
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>海上求生技能坊-海上音樂家訓練Compose</Text>
                <Image 
                  style={styles.backdrop} 
          ...
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>海上求生技能坊-水手默契訓練</Text>
                <Image 
                  style={styles.backdrop} 
                  source={require('../../images/workshop/B水手默契訓練Experience Activities-萬長平.jpg')}>
                    <View style={styles.backdropView}>
          ...
          <View style={styles.container}>
            <View style={{marginTop:50, flex: 1, justifyContent:'flex-start', alignItems:'center'}}>
              <Text style={styles.text}>海上求生技能坊-艦隊經營學Career Analysis</Text>
                <Image 
                  style={styles.backdrop} 
